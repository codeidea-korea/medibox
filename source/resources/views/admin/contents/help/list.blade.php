...
<section class="container">
	...
	function getList(){
		...
		medibox.methods.contents.help.list(data, function(request, response){
	...
	function gotoDetail(seq){
		location.href = '/admin/contents/helps/'+seq;
	}
	function addItem(){
		location.href = '/admin/contents/helps/0';
	}		
