@php 
$page_title = '공지사항 (유저/APP)';
@endphp
@include('admin.header')

<section class="container">
	<div class="page-title">공지사항 (유저/APP)</div>
	...
	function getList(){
		...
		medibox.methods.contents.notice.list(data, function(request, response){
	...
	function gotoDetail(seq){
		location.href = '/admin/contents/notices/'+seq;
	}
	function addItem(){
		location.href = '/admin/contents/notices/0';
	}		
