...
<section class="container">
	...
	function getList(){
		...
		medibox.methods.contents.privacy.list(data, function(request, response){
	...
	function gotoDetail(seq){
		location.href = '/admin/contents/privacies/'+seq;
	}
	function addItem(){
		location.href = '/admin/contents/privacies/0';
	}		
