...
@include('user.header')
    ...
    function checkApprove(){
        medibox.methods.point.coupon.checkApprove({ user_seqno: {{ $userSeqno }}, hst_seqno: {{ $id }} }, function(request, response){
    ...
    function closePop(){
        $('#popup20').removeClass('on');
        $('#popup21').removeClass('on');
