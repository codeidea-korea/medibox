...
@include('user.header2')
    ...
    <section id="brand_intro">
        <div class="brand_item_slider">
            ...
            @php 
            if($brandInfo->slide_img_01 != ''){
                echo '<figure class="minish_spa01" style="background:url('.$brandInfo->slide_img_01 . ') no-repeat center center/cover;"></figure>';
            }
            if($brandInfo->slide_img_02 != ''){
                echo '<figure class="minish_spa02" style="background:url('.$brandInfo->slide_img_02 . ') no-repeat center center/cover;"></figure>';
            }
            if($brandInfo->slide_img_03 != ''){
                echo '<figure class="minish_spa03" style="background:url('.$brandInfo->slide_img_03 . ') no-repeat center center/cover;"></figure>';
            }
            if($brandInfo->slide_img_04 != ''){
                echo '<figure class="minish_spa04" style="background:url('.$brandInfo->slide_img_04 . ') no-repeat center center/cover;"></figure>';
            }
            if($brandInfo->slide_img_05 != ''){
                echo '<figure class="minish_spa05" style="background:url('.$brandInfo->slide_img_05 . ') no-repeat center center/cover;"></figure>';
            }            
            @endphp
        ...
        <div class="brand_item_des">
            <h2>{{$brandInfo->cop_name}}</h2>

            <!-- 22.03.30 수정 -->
            <!-- <span>Minsh Spa</span> -->
            <span>{{$brandInfo->cop_eng_name}}</span>
